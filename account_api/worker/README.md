...
2. **Payment Links** — desktop app opens these URLs; prod redirect: `https://frogswork.com/subscribe/success.html?session_id={CHECKOUT_SESSION_ID}`.
...
5. **Buy Buttons** (optional on marketing site) — same Payment Links as the app; see [`../../docs/commercial/STRIPE_SETUP.md`](../../docs/commercial/STRIPE_SETUP.md).
