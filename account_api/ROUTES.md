...
| GET | `/account/tax-export` | Bearer | Tax-time ZIP: `?fy=2025-26` optional `&business=Name` — income ledger CSV + summary + `invoice_pdfs/` for AU FY (cash basis + unpaid in FY); rate limited |
